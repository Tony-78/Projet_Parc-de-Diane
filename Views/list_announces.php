...
<head>
    ...
    <title>Annonces - Parc de Diane</title>
</head>
    ...
    ?>
        <div class="container">
            <div class="text-center mb-4">
                <a href="create_announce.php" class="btn btn-sm btn-primary">Ajouter une annonce</a>
            </div>
        ...
        <div class="mt-3 text-center mb-5">
            <a class="btn btn-info btn-sm" href="list_announces.php?page=1">
                <<</a>
                    <a class="btn btn-info btn-sm" href="list_announces.php?page=<?= $actualPage > 1 ? $actualPage - 1 : 1 ?>">
                        <</a>
